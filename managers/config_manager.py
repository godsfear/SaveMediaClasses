...
class ConfigManager:
    ...
    def load(self) -> AppState:
        ...
        return AppState(
            ...
            history_keep_days = max(0, safe_int(cfg.get("history_keep_days"),
    ...
    def save(self, state: AppState) -> None:
        ...
        data = {
            "settings": {
                ...
                "history_keep_days": state.history_keep_days,
        ...
        tmp_path = f"{self.config_file}.tmp"   # config_file — Path в приложении, str в старых вызовах
        try:
